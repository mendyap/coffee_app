...
def get_drinks():
    ...
    drink_short = []
    '''
    # iterate through drinks list and append the .short formatted
     version (see models.py for implementation) to the above list
    '''
    for drink in drinks:
        drink_short.append(drink.short())

    # return jsonified response that includes the drinks data in .short format
    return jsonify({
        'success': True,
        'status_code': 200,
        'drinks': drink_short
...
def get_drinks_detail():
    ...
    drink_long = []
    '''
    iterate through list of drinks and append them in .long form
    (see models.py for implementation) to the list above
    '''
    for drink in drinks:
...
def update_drinks(id):
    '''
    retrieve drink data from DB filtered by the ID passed into
    the function from the http request
    '''
